...
1.Внедрить Hilt и Room.
2.Рефакторить в MVVM с корутинами.
3.Обновить UI на RecyclerView + Material 3 — современные руководства.
5.Упорядочить проект по модулям — соответствует индустриальным стандартам.
